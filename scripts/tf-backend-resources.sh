...
USER_NAME="terraform_user_aminosebti3"
...
# Create S3 Bucket
S3_BUCKET_NAME="tf-remote-backends-ehb-aminosebti3"
...
aws dynamodb create-table \
  --table-name "tf-lock-table-ehb-aminoesebti3" \
